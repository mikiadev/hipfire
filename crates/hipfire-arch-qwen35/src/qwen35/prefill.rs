...
fn dispatch_batched_gemm_epilogue(
    ...
    let is_lowbit = matches!(w.gpu_dtype, DType::TQ2G128 | DType::BQ1G128 | DType::Q4K | DType::IQ4XS | DType::Q2K | DType::IQ3S | DType::IQ3XXS);
    match epilogue {
...
pub(crate) fn is_batchable_la(dt: DType, arch: &str) -> bool {
    let always_ok = matches!(
        ...
        | DType::TQ2G128 | DType::BQ1G128 | DType::Q4K | DType::IQ4XS | DType::Q2K | DType::IQ3S | DType::IQ3XXS
...
pub(crate) fn batch_chunk_delta_net_attn(
    ...
    let is_lowbit = matches!(layer.wqkv.gpu_dtype, DType::TQ2G128 | DType::BQ1G128 | DType::Q4K | DType::IQ4XS | DType::Q2K | DType::IQ3S | DType::IQ3XXS);
    ...
    let la_has_native_iq = matches!(layer.wqkv.gpu_dtype, DType::IQ4XS | DType::Q2K | DType::IQ3S | DType::IQ3XXS | DType::Q4K)
        || matches!(layer.wz.gpu_dtype, DType::IQ4XS | DType::Q2K | DType::IQ3S | DType::IQ3XXS | DType::Q4K)
        || matches!(layer.w_beta.gpu_dtype, DType::IQ4XS | DType::Q2K | DType::IQ3S | DType::IQ3XXS | DType::Q4K)
        || matches!(layer.w_alpha.gpu_dtype, DType::IQ4XS | DType::Q2K | DType::IQ3S | DType::IQ3XXS | DType::Q4K);
...
pub(crate) fn batch_chunk_delta_net_ffn(
    ...
    // to the HFQ4 arm, which would read these packed blocks at the wrong
    // stride and produce fluent-but-wrong tokens.
    let ffn_is_lowbit = matches!(layer.w_gate.gpu_dtype, DType::TQ2G128 | DType::BQ1G128 | DType::Q4K | DType::IQ4XS | DType::Q2K | DType::IQ3S | DType::IQ3XXS);
    ...
    } else if ffn_is_mq && !ffn_gate_up_mixed && matches!(layer.w_down.gpu_dtype, DType::IQ4XS | DType::Q2K | DType::IQ3S | DType::IQ3XXS | DType::Q4K) {
...
pub(crate) fn batch_chunk_full_attn_attn(
    ...
    // to the HFQ4 arm, which would read these packed blocks at the wrong
    // stride and produce fluent-but-wrong tokens.
    let qkv_is_lowbit = matches!(layer.wq.gpu_dtype, DType::TQ2G128 | DType::BQ1G128 | DType::Q4K | DType::IQ4XS | DType::Q2K | DType::IQ3S | DType::IQ3XXS);
    ...
    let fa_has_native_iq = matches!(layer.wq.gpu_dtype, DType::IQ4XS | DType::Q2K | DType::IQ3S | DType::IQ3XXS | DType::Q4K)
        || matches!(layer.wk.gpu_dtype, DType::IQ4XS | DType::Q2K | DType::IQ3S | DType::IQ3XXS | DType::Q4K)
        || matches!(layer.wv.gpu_dtype, DType::IQ4XS | DType::Q2K | DType::IQ3S | DType::IQ3XXS | DType::Q4K);
...
pub(crate) fn batch_chunk_full_attn_ffn(
    ...
    // to the HFQ4 arm, which would read these packed blocks at the wrong
    // stride and produce fluent-but-wrong tokens.
    let fa_ffn_is_lowbit = matches!(layer.w_gate.gpu_dtype, DType::TQ2G128 | DType::BQ1G128 | DType::Q4K | DType::IQ4XS | DType::Q2K | DType::IQ3S | DType::IQ3XXS);
    ...
    if fa_w_down_is_mq {
        ...
        && matches!(layer.w_down.gpu_dtype, DType::IQ4XS | DType::Q2K | DType::IQ3S | DType::IQ3XXS | DType::Q4K) {
...
fn batch_chunk_delta_net_moe(
    ...
    // to the HFQ4 arm, which would read these packed blocks at the wrong
    // stride and produce fluent-but-wrong tokens.
    let dn_wo_is_lowbit = matches!(layer.wo.gpu_dtype, DType::TQ2G128 | DType::BQ1G128 | DType::Q4K | DType::IQ4XS | DType::Q2K | DType::IQ3S | DType::IQ3XXS);
...
fn batch_chunk_full_attn_moe(
    ...
    // to the HFQ4 arm, which would read these packed blocks at the wrong
    // stride and produce fluent-but-wrong tokens.
    let fa_wo_is_lowbit = matches!(layer.wo.gpu_dtype, DType::TQ2G128 | DType::BQ1G128 | DType::Q4K | DType::IQ4XS | DType::Q2K | DType::IQ3S | DType::IQ3XXS);
