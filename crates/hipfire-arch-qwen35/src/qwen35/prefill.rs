...
fn dispatch_batched_gemm_epilogue(
    ...
    let is_lowbit = matches!(w.gpu_dtype, DType::TQ2G128 | DType::BQ1G128 | DType::Q4K | DType::IQ4XS | DType::Q2K | DType::IQ3S | DType::IQ3XXS | DType::IQ2S | DType::IQ2XS | DType::IQ2XXS);
    match epilogue {
...
fn plain_gemm_key_for(dt: DType) -> hipfire_dispatch::types::KernelKey {
    ...
    match dt {
        ...
        DType::IQ3XXS => K::GemmIQ3XXSBatched,
        DType::IQ2S => K::GemmIQ2SBatched,
        DType::IQ2XS => K::GemmIQ2XSBatched,
        DType::IQ2XXS => K::GemmIQ2XXSBatched,
...
pub(crate) fn is_batchable_la(dt: DType, arch: &str) -> bool {
    let always_ok = matches!(
        ...
        | DType::TQ2G128 | DType::BQ1G128 | DType::Q4K | DType::IQ4XS | DType::Q2K | DType::IQ3S | DType::IQ3XXS | DType::IQ2S | DType::IQ2XS | DType::IQ2XXS
...
pub(crate) fn batch_chunk_delta_net_attn(
    ...
    let is_lowbit = matches!(layer.wqkv.gpu_dtype, DType::TQ2G128 | DType::BQ1G128 | DType::Q4K | DType::IQ4XS | DType::Q2K | DType::IQ3S | DType::IQ3XXS | DType::IQ2S | DType::IQ2XS | DType::IQ2XXS);
    ...
    let la_has_native_iq = matches!(layer.wqkv.gpu_dtype, DType::IQ4XS | DType::Q2K | DType::IQ3S | DType::IQ3XXS | DType::IQ2S | DType::IQ2XS | DType::IQ2XXS | DType::Q4K)
        || matches!(layer.wz.gpu_dtype, DType::IQ4XS | DType::Q2K | DType::IQ3S | DType::IQ3XXS | DType::IQ2S | DType::IQ2XS | DType::IQ2XXS | DType::Q4K)
        || matches!(layer.w_beta.gpu_dtype, DType::IQ4XS | DType::Q2K | DType::IQ3S | DType::IQ3XXS | DType::IQ2S | DType::IQ2XS | DType::IQ2XXS | DType::Q4K)
        || matches!(layer.w_alpha.gpu_dtype, DType::IQ4XS | DType::Q2K | DType::IQ3S | DType::IQ3XXS | DType::IQ2S | DType::IQ2XS | DType::IQ2XXS | DType::Q4K);
...
pub(crate) fn batch_chunk_delta_net_ffn(
    ...
    // to the HFQ4 arm, which would read these packed blocks at the wrong
    // stride and produce fluent-but-wrong tokens.
    let ffn_is_lowbit = matches!(layer.w_gate.gpu_dtype, DType::TQ2G128 | DType::BQ1G128 | DType::Q4K | DType::IQ4XS | DType::Q2K | DType::IQ3S | DType::IQ3XXS | DType::IQ2S | DType::IQ2XS | DType::IQ2XXS);
    ...
    } else if ffn_is_mq && !ffn_gate_up_mixed && matches!(layer.w_down.gpu_dtype, DType::IQ4XS | DType::Q2K | DType::IQ3S | DType::IQ3XXS | DType::IQ2S | DType::IQ2XS | DType::IQ2XXS | DType::Q4K) {
...
pub(crate) fn batch_chunk_full_attn_attn(
    ...
    // to the HFQ4 arm, which would read these packed blocks at the wrong
    // stride and produce fluent-but-wrong tokens.
    let qkv_is_lowbit = matches!(layer.wq.gpu_dtype, DType::TQ2G128 | DType::BQ1G128 | DType::Q4K | DType::IQ4XS | DType::Q2K | DType::IQ3S | DType::IQ3XXS | DType::IQ2S | DType::IQ2XS | DType::IQ2XXS);
    ...
    let fa_has_native_iq = matches!(layer.wq.gpu_dtype, DType::IQ4XS | DType::Q2K | DType::IQ3S | DType::IQ3XXS | DType::IQ2S | DType::IQ2XS | DType::IQ2XXS | DType::Q4K)
        || matches!(layer.wk.gpu_dtype, DType::IQ4XS | DType::Q2K | DType::IQ3S | DType::IQ3XXS | DType::IQ2S | DType::IQ2XS | DType::IQ2XXS | DType::Q4K)
        || matches!(layer.wv.gpu_dtype, DType::IQ4XS | DType::Q2K | DType::IQ3S | DType::IQ3XXS | DType::IQ2S | DType::IQ2XS | DType::IQ2XXS | DType::Q4K);
...
pub(crate) fn batch_chunk_full_attn_ffn(
    ...
    // to the HFQ4 arm, which would read these packed blocks at the wrong
    // stride and produce fluent-but-wrong tokens.
    let fa_ffn_is_lowbit = matches!(layer.w_gate.gpu_dtype, DType::TQ2G128 | DType::BQ1G128 | DType::Q4K | DType::IQ4XS | DType::Q2K | DType::IQ3S | DType::IQ3XXS | DType::IQ2S | DType::IQ2XS | DType::IQ2XXS);
    ...
    if fa_w_down_is_mq {
        ...
        && matches!(layer.w_down.gpu_dtype, DType::IQ4XS | DType::Q2K | DType::IQ3S | DType::IQ3XXS | DType::IQ2S | DType::IQ2XS | DType::IQ2XXS | DType::Q4K) {
...
fn batch_chunk_full_attn_moe(
    ...
    // to the HFQ4 arm, which would read these packed blocks at the wrong
    // stride and produce fluent-but-wrong tokens.
    let fa_wo_is_lowbit = matches!(layer.wo.gpu_dtype, DType::TQ2G128 | DType::BQ1G128 | DType::Q4K | DType::IQ4XS | DType::Q2K | DType::IQ3S | DType::IQ3XXS | DType::IQ2S | DType::IQ2XS | DType::IQ2XXS);
...
fn batched_gemm_single_weight(
    ...
    match w.gpu_dtype {
        ...
        DType::IQ3XXS => {
            // GSQ-RCO native: IQ3_XXS is unrotated (RotationPlan::None) —
            // plain batched GEMM over the release's own blocks.
            run_plain_gemm_key(
                gpu,
                hipfire_dispatch::types::KernelKey::GemmIQ3XXSBatched,
                &w.buf,
                w.gpu_dtype,
                x,
                y,
        ...
        DType::IQ2S => {
            // GSQ-RCO native: IQ2_S is unrotated (RotationPlan::None) —
            // plain batched GEMM over the release's own blocks.
            run_plain_gemm_key(
                gpu,
                hipfire_dispatch::types::KernelKey::GemmIQ2SBatched,
                &w.buf,
                w.gpu_dtype,
                x,
                y,
        ...
        DType::IQ2XS => {
            // GSQ-RCO native: IQ2_XS is unrotated (RotationPlan::None).
            run_plain_gemm_key(
                gpu,
                hipfire_dispatch::types::KernelKey::GemmIQ2XSBatched,
                &w.buf,
                w.gpu_dtype,
                x,
                y,
        ...
        DType::IQ2XXS => {
            // GSQ-RCO native: IQ2_XXS is unrotated (RotationPlan::None).
            run_plain_gemm_key(
                gpu,
                hipfire_dispatch::types::KernelKey::GemmIQ2XXSBatched,
                &w.buf,
                w.gpu_dtype,
                x,
                y,
...
mod tests {
    ...
    fn qwen35_is_batchable_la_unsupported_dtypes() {
        for &arch in WMMA_ARCHS {
            ...
            assert!(
                is_batchable_la(DType::IQ3XXS, arch),
                "IQ3XXS routes via GemmIQ3XXSBatched"
            );
            assert!(
                is_batchable_la(DType::IQ2S, arch),
                "IQ2S routes via GemmIQ2SBatched"
            );
